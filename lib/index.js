...
(function() {
  var Robot, directiveValues, directives, directivesWithNoUnits, log,
    slice = [].slice,
  ...
  Robot = (function() {
    ...
    Robot.prototype.render = function(opts, dslFunc) {
    ...
    Robot.prototype.fuzzyMatch = function(txt, names) {
    ...
    Robot.prototype.renderDirective = function(name, value) {
    ...
    Robot.prototype.topSpace = function() {
      var space;
    ...
    Robot.prototype.topSelector = function(nestChar) {
      var selector;
    ...
    Robot.prototype.addSpace = function(selector) {
    ...
    Robot.prototype.nestFunc = function() {
    ...
    Robot.prototype._ = function() {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return this.nestFunc.apply(this, [''].concat(slice.call(args)));
    };

    Robot.prototype._s = function() {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return this.nestFunc.apply(this, [' '].concat(slice.call(args)));
    };

    Robot.prototype._v = function() {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return this.nestFunc.apply(this, [' > '].concat(slice.call(args)));
    };

    Robot.prototype._p = function() {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return this.nestFunc.apply(this, [' + '].concat(slice.call(args)));
    };

    Robot.prototype.comment = function(text) {
      return this.raw("/*" + text + "*/");
    };

    Robot.prototype.raw = function(s) {
      if (s == null) {
        s = '';
      }
